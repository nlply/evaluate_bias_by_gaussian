...
def load_tokenizer_and_model(args):
    ...
    '''
    if args.model == 'bert':
        pretrained_weights = '../models/bert-base-cased'
    elif args.model == "roberta":
        pretrained_weights = '../models/roberta-large'
    elif args.model == "albert":
        pretrained_weights = '../models/albert-large-v2'
    else:
...
def main(args):
    ...
    if args.sample_rate == 1:
        data_path = f'{args.input}paralled_{args.data}.json'
    else:
        data_path = f'{input}paralled_{args.data}_{args.sample_rate}.json'
    with open(data_path) as f:
        ...
        if args.sample_rate == 1:
            ...
            save_path = args.output + str(args.sample_rate) + '_' + args.data + '_' + args.method + '_' + args.model + '.json'
